  ...
  return (
    <ScreenContainer>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
        <div onClick={() => navigation.navigate('GPS')} className="bg-surface p-5 rounded-xl border border-slate-700 hover:border-primary/50 hover:bg-slate-800 transition-all cursor-pointer group">
        ...
        <div onClick={() => navigation.navigate('Bluetooth')} className="bg-surface p-5 rounded-xl border border-slate-700 hover:border-yellow-500/50 hover:bg-slate-800 transition-all cursor-pointer group">
        ...
        <div onClick={() => navigation.navigate('Notifications')} className="bg-surface p-5 rounded-xl border border-slate-700 hover:border-pink-500/50 hover:bg-slate-800 transition-all cursor-pointer group">
